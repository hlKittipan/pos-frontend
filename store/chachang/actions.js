export default {
  ...
  async fetchLanguage({ commit }) {
    const response = await this.$axios.get(
      this.$config.axios.BASE_API_URL + '/chachang/language-code'
    )
  ...
  async addLanguage({ commit }, value) {
    const response = await this.$axios
      .post(this.$config.axios.BASE_API_URL + '/chachang/language-code', value)
      .catch(({ response }) => {
        console.log('fail')
        return response
      })
  ...
  async updateLanguage({ commit }, value) {
    const response = await this.$axios.put(
      this.$config.axios.BASE_API_URL + '/chachang/language-code/' + value.id,
      value
    )
    if (response.status == 200) {
  ...
  async deleteLanguage({ commit }, id) {
    const response = await this.$axios.delete(
      this.$config.axios.BASE_API_URL + '/chachang/language-code/' + id
    )
    if (response.status == 200) {
  ...
  async fetchPriceType({ commit }) {
    const response = await this.$axios.get(
      this.$config.axios.BASE_API_URL + '/chachang/price-type'
    )
    if (response.status == 200) {
  ...
  async updatePriceType({ commit }, value) {
    const response = await this.$axios.put(
      this.$config.axios.BASE_API_URL + '/chachang/price-type/' + value.id,
      value
    )
    if (response.status == 200) {
  ...
  async deletePriceType({ commit }, id) {
    const response = await this.$axios.delete(
      this.$config.axios.BASE_API_URL + '/chachang/price-type/' + id
    )
    if (response.status == 200) {
  ...
  async fetchPriceTemplate({ commit }) {
    const response = await this.$axios.get(
      this.$config.axios.BASE_API_URL + '/chachang/price-template'
    )
    if (response.status == 200) {
  ...
  async updatePriceTemplate({ commit }, value) {
    const response = await this.$axios.put(
      this.$config.axios.BASE_API_URL + '/chachang/price-template/' + value.id,
      value
    )
    if (response.status == 200) {
  ...
  async deletePriceTemplate({ commit }, id) {
    const response = await this.$axios.delete(
      this.$config.axios.BASE_API_URL + '/chachang/price-template/' + id
    )
    if (response.status == 200) {
  ...
  async fetchPaymentType({ commit }) {
    const response = await this.$axios.get(
      this.$config.axios.BASE_API_URL + '/chachang/payment-type'
    )
    if (response.status == 200) {
  ...
  async updatePaymentType({ commit }, value) {
    const response = await this.$axios.put(
      this.$config.axios.BASE_API_URL + '/chachang/payment-type/' + value.id,
      value
    )
    if (response.status == 200) {
  ...
  async deletePaymentType({ commit }, id) {
    const response = await this.$axios.delete(
      this.$config.axios.BASE_API_URL + '/chachang/payment-type/' + id
    )
    if (response.status == 200) {
  ...
  async fetchProduct({ commit }) {
    ...
    const response = await this.$axios.get(
      this.$config.axios.BASE_API_URL + '/chachang/product'
    )
    if (response.status == 200) {
  ...
  async updateProduct({ commit }, value) {
    const response = await this.$axios.put(
      this.$config.axios.BASE_API_URL + '/chachang/product/' + value.id,
      value
    )
    if (response.status == 200) {
  ...
  async deleteProduct({ commit }, id) {
    const response = await this.$axios
      .delete(this.$config.axios.BASE_API_URL + '/chachang/product/' + id)
      .catch(({ response: err }) => {
        return err
      })
  ...
  async fetchProductType({ commit }) {
    const response = await this.$axios.get(
      this.$config.axios.BASE_API_URL + '/chachang/product-type'
    )
    if (response.status == 200) {
  ...
  async updateProductType({ commit }, value) {
    const response = await this.$axios.put(
      this.$config.axios.BASE_API_URL + '/chachang/product-type/' + value.id,
      value
    )
    if (response.status == 200) {
  ...
  async deleteProductType({ commit }, id) {
    const response = await this.$axios.delete(
      this.$config.axios.BASE_API_URL + '/chachang/product-type/' + id
    )
    if (response.status == 200) {
