...
export default {
  ...
  async beforeCreate() {
    ...
    this.data = this.$store.getters['pos/getProductTypeList']
  ...
  computed: {
    getProductTypeList(){
      return this.$store.getters['pos/getProductTypeList']
    }
  },
  methods: {
    ...
    async save(id) {
      ...
      console.log(target)
      const response = await this.$store.dispatch('pos/updateProductType',target)
      if (response) {
    ...
    async onDelete(id) {
      const newData = [...this.data]
      const response = await this.$store.dispatch('pos/deleteProductType',id)
      if (response) {
        this.$notification.open({
