...
export default {
  name: 'LanguageList',
  async beforeCreate() {
    const pricetype = await this.$store.dispatch('pos/fetchLanguage')
    if(pricetype) {
      this.data = this.$store.getters['pos/getLanguageCode']
  ...
  computed: {
    getLanguageCode(){
      return this.$store.getters['pos/getLanguageCode']
    }
  },
  methods: {
    ...
    async save(id) {
      ...
      console.log(target)
      const response = await this.$store.dispatch('pos/updateLanguage',target)
      if (response) {
    ...
    async onDelete(id) {
      const newData = [...this.data]
      const response = await this.$store.dispatch('pos/deleteLanguage',id)
      if (response) {
        this.$notification.open({
