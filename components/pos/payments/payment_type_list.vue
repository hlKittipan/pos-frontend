...
export default {
  ...
  async beforeCreate() {
    const paymentType = await this.$store.dispatch('pos/fetchPaymentType')
    if (paymentType){
      this.data = this.$store.getters['pos/getPaymentTypeList']
  ...
  computed: {
    getPaymentTypeList(){
      return this.$store.getters['pos/getPaymentTypeList']
    }
  },
  methods: {
    ...
    async save(id) {
      ...
      const response = await this.$store.dispatch('pos/updatePaymentType',target)
      if (response) {
    ...
    async onDelete(id) {
      const newData = [...this.data]
      const response = await this.$store.dispatch('pos/deletePaymentType',id)
      if (response) {
        this.$notification.open({
